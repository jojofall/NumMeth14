...
int main(){
       ...
       double k1,k2,k3,k4,Phi,h,runtime;
...
/*     Daten einlesen       */ 
	...
	cout<<"Eingelesene Werte: "<<endl<<"Länge: "<<length<<endl<<"Masse: "<<mass<<endl<<"theta0: "<<thetaZero<<endl<<"Etha: "<<etha<<endl<<"Kraft: "<<Force<<endl<<"Omega: "<<Omega<<endl;
